...
namespace app.ExcelAdapter
{
    public class ExcelAdapter : IExcelAdapter
    {
        ...
        public Excel GetPermission(IEnumerable<Permission> permissions)
        {
            ...
            var sheetName = _localizer["SheetNameExcelPermission"].Value;
            ...
            ConfigExcelGeneralSettings(sheet, lastColumn, _localizer, "SheetNameExcelPermission");
            ...
            foreach (var item in permissions)
            {
                ...
                sheet.Cells[i, 2].Value = item.Name;
                sheet.Cells[i, 3].Value = item.Description;
        ...
        public Excel GetPermissionModel()
        {
            ...
            ConfigExcelGeneralSettings(sheet, headers.Count(), _localizer, "TitleExcelImportPermission");
            ...
            return new Excel($"{_localizer["TitleExcelImportPermission"].Value}.xlsx", excel.GetAsByteArray());
        }
